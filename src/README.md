...
- [2] `midm.py`
  ...
  - `os.environ.setdefault("TRANSFORMERS_MODEL", "K-intelligence/Midm-2.0-Base-Instruct")` -> `os.environ.setdefault("TRANSFORMERS_MODEL", "K-intelligence/Midm-2.0-Mini-Instruct")`
